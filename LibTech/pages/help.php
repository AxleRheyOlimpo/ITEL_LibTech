...
<body>
  ...
  <div class="help-container">
    ...
    <h1 style="color: #1f5c70; margin-bottom: 15px;">Help & Support</h1>
    <p style="color: #666; margin-bottom: 30px;">
      Help page is under construction.<br>
      This will include FAQs, tutorials, and support ticket system (threading).
    </p>
